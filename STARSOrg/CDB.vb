...
Public Class CDB
    Public Function OpenDB() As Boolean
        ...
        If objSQLConn Is Nothing Then 'need to instantiate the connection object
            Try
                objSQLConn = New SqlConnection(gstrConn)
                objSQLConn.Open()
                blnResult = True
            Catch exOpenConnError As Exception
                MessageBox.Show("Cannot open database: " & exOpenConnError.ToString(),
    ...
    Public Function GetSingleValueFromSP(ByVal strSP As String, ByRef params As ArrayList) As String
        ...
        If Not sqlDR Is Nothing Then  'get data reader successful
            If sqlDR.Read Then 'data is present in reader
